...
<table id="toolbar">
 <tr>
  <td class="toolbar"><input type="image" class="input" src="<?php echo $basedir; ?>img/new.svg"
   width="48px" height="48px" alt="New" title="New Domain" id="btn_new"
   onclick="document.location.reload(true)" /></td>
  <td class="toolbar"><input type="image" class="input" src="<?php echo $basedir; ?>img/open.svg"
   width="48px" height="48px" alt="Open" title="Open Existing Domain" id="btn_open"
   onclick="backend.get_domains(ui.list_domains)" /></td>
  <td class="toolbar"><input type="image" class="input" src="<?php echo $basedir; ?>img/save.svg"
   width="48px" height="48px" alt="Save" title="Save As..." id="btn_save"
   onclick="$('#dia_create_domain').dialog('open')" /></td>
 ...
 <table id="input">
  ...
  <tr class="col_del">
   ...
   <td class="right td_attr_0"><input type="image" src="<?php echo $basedir; ?>img/delete.svg"
    width="16px" height="16px" alt="x" title="Delete Attribute" id="btn_del_attr_0"
   ...
   <td class="right td_attr_1"><input type="image" src="<?php echo $basedir; ?>img/delete.svg"
    width="16px" height="16px" alt="x" title="Delete Attribute" id="btn_del_attr_1"
   ...
   <td class="right td_attr_2"><input type="image" src="<?php echo $basedir; ?>img/delete.svg"
    width="16px" height="16px" alt="x" title="Delete Attribute" id="btn_del_attr_2"
   ...
   <td class="right td_attr_3"><input type="image" src="<?php echo $basedir; ?>img/delete.svg"
    width="16px" height="16px" alt="x" title="Delete Attribute" id="btn_del_attr_3"
  ...
  <tr>
   ...
   <td class="td_attr td_attr_0"><input type="image" src="<?php echo $basedir; ?>img/left.svg"
    id="btn_move_left_0" width="16px" height="40px" alt="&lt;" title="Move Left"
    class="input btn_move_left" onclick="ui.move_left(0)" /><input type="image"
    src="<?php echo $basedir; ?>img/right.svg" id="btn_move_right_0" width="16px" height="40px"
    alt="&gt;" title="Move Right" class="input btn_move_right" onclick="ui.move_right(0)" /><input
    type="button" id="attr_0" class="input fullheight btn_attr col" value="Dummy Attribute 1"
    onclick="ui.set_item(0,1)" /></td>
   <td class="td_attr td_attr_1"><input type="image" src="<?php echo $basedir; ?>img/left.svg"
    ...
    alt="&gt;" title="Move Right" class="input btn_move_right" onclick="ui.move_right(1)" /><input
    type="button" id="attr_1" class="input fullheight btn_attr col" value="Dummy Attribute 2"
    onclick="ui.set_item(1,1)" /></td>
   <td class="td_attr td_attr_2"><input type="image" src="<?php echo $basedir; ?>img/left.svg"
    ...
    alt="&gt;" title="Move Right" class="input btn_move_right" onclick="ui.move_right(2)" /><input
    type="button" id="attr_2" class="input fullheight btn_attr col" value="Dummy Attribute 3"
    onclick="ui.set_item(2,1)" /></td>
   <td class="td_attr td_attr_3"><input type="image" src="<?php echo $basedir; ?>img/left.svg"
    ...
    alt="&gt;" title="Move Right" class="input btn_move_right" onclick="ui.move_right(3)" /><input
    type="button" id="attr_3" class="input fullheight btn_attr col" value="Dummy Attribute 4"
    onclick="ui.set_item(3,1)" /></td>
   <td class="tail" style="background-color: #fff; vertical-alignment: middle"><input type="image"
    ...
    title="Add Attribute" onclick="ui.append_attribute()" />Add Attribute</td>
  </tr>
  <tr id="tr_obj_0" class="tr_obj">
   <td class="left"><input type="image" src="<?php echo $basedir; ?>img/up.svg" width="40px"
    height="16px" alt="^" title="Move Up" id="btn_move_up_0" class="input btn_move_up"
    onclick="ui.move_up(0)" /> <input type="image" src="<?php echo $basedir; ?>img/down.svg"
    width="40px" height="16px" alt="v" title="Move Up" id="btn_move_down_0"
    ...
    title="Remove Object" id="btn_del_obj_0" class="input btn_del_obj" onclick="ui.rem_object(0)" />
    <input type="button" id="obj_0" class="input btn_obj" value="Dummy Object 1"
  ...
  <tr id="tr_obj_1" class="tr_obj">
   <td class="left"><input type="image" src="<?php echo $basedir; ?>img/up.svg" width="40px"
    height="16px" alt="^" title="Move Up" id="btn_move_up_1" class="input btn_move_up"
    onclick="ui.move_up(1)" /> <input type="image" src="<?php echo $basedir; ?>img/down.svg"
    width="40px" height="16px" alt="v" title="Move Up" id="btn_move_down_1"
    class="input btn_move_down" onclick="ui.move_down(1)" /> <input type="image"
    src="<?php echo $basedir; ?>img/delete.svg" width="16px" height="16px" alt="x"
    title="Remove Object" id="btn_del_obj_1" class="input btn_del_obj" onclick="ui.rem_object(1)" />
    <input type="button" id="obj_1" class="input btn_obj" value="Dummy Object 2"
  ...
  <tr id="tr_obj_2" class="tr_obj">
   <td class="left"><input type="image" src="<?php echo $basedir; ?>img/up.svg" width="40px"
    height="16px" alt="^" title="Move Up" id="btn_move_up_2" class="input btn_move_up"
    onclick="ui.move_up(2)" /> <input type="image" src="<?php echo $basedir; ?>img/down.svg"
    width="40px" height="16px" alt="v" title="Move Up" id="btn_move_down_2"
    class="input btn_move_down" onclick="ui.move_down(2)" /> <input type="image"
    src="<?php echo $basedir; ?>img/delete.svg" width="16px" height="16px" alt="x"
    title="Remove Object" id="btn_del_obj_2" class="input btn_del_obj" onclick="ui.rem_object(2)" /><input
    type="button" id="obj_2" class="input btn_obj" value="Dummy Object 3" onclick="ui.set_item(2,0)" /></td>
  ...
  <tr id="tr_obj_3" class="tr_obj">
   <td class="left"><input type="image" src="<?php echo $basedir; ?>img/up.svg" width="40px"
    height="16px" alt="^" title="Move Up" id="btn_move_up_3" class="input btn_move_up"
    onclick="ui.move_up(3)" /> <input type="image" src="<?php echo $basedir; ?>img/down.svg"
    width="40px" height="16px" alt="v" title="Move Up" id="btn_move_down_3"
    class="input btn_move_down" onclick="ui.move_down(3)" /> <input type="image"
    src="<?php echo $basedir; ?>img/delete.svg" width="16px" height="16px" alt="x"
    title="Remove Object" id="btn_del_obj_3" class="input btn_del_obj" onclick="ui.rem_object(3)" /><input
    type="button" id="obj_3" class="input btn_obj" value="Dummy Object 4" onclick="ui.set_item(3,0)" /></td>
  ...
  <tr id="tr_obj_4" class="tr_obj">
   <td class="left"><input type="image" src="<?php echo $basedir; ?>img/up.svg" width="40px"
    height="16px" alt="^" title="Move Up" id="btn_move_up_4" class="input btn_move_up"
    onclick="ui.move_up(4)" /> <input type="image" src="<?php echo $basedir; ?>img/down.svg"
    width="40px" height="16px" alt="v" title="Move Up" id="btn_move_down_4"
    class="input btn_move_down" onclick="ui.move_down(4)" /> <input type="image"
    src="<?php echo $basedir; ?>img/delete.svg" width="16px" height="16px" alt="x"
    title="Remove Object" id="btn_del_obj_4" class="input btn_del_obj" onclick="ui.rem_object(4)" /><input
    type="button" id="obj_4" class="input btn_obj" value="Dummy Object 5" onclick="ui.set_item(4,0)" /></td>
  ...
  <tr class="obj_tail">
   <td class="center"><input type="image" class="input" style="border: none"
    src="<?php echo $basedir; ?>img/plus.svg" width="16px" height="16px" alt="+" title="Add Object"
    id="btn_obj_add" class="fixed_height" onclick="ui.append_object()" /> Add Object</td>
...
<div id="dia_set_obj" title="Set Object">
 <div id="dia_set_obj_content">
  <table>
   <tr>
    <td class="layout_select_name">Select an Object</td>
   ...
   <tr class="descr_detail">
    <td class="layout_select">Description</td>
    <td><textarea id="text_descr_obj" rows="5" cols="35" class="text_description"
      readonly="readonly"></textarea></td>
    <td></td>
   </tr>
   <tr class="descr_detail">
    <td class="layout_select">Learning Objects</td>
    <td>
 ...
 <div class="choice">
  <hr>
  <input id="btn_choose_obj_cancel" type="button" class="input_pad" value="Cancel"
   onclick="$('#dia_set_obj').dialog('close')" /> <input id="btn_choose_obj_ok" class="input_pad"
   type="button" value="OK" onclick="logic.choose_object()" />
 </div>
</div>



<div id="dia_set_attr" title="Set Attribute">
 <div id="dia_set_attr_content">
  <table>
   <tr>
    <td class="layout_select_name">Select an attribute</td>
   ...
   <tr class="descr_detail">
    <td class="layout_select">Description</td>
    <td><textarea id="text_descr_attr" rows="5" cols="35" class="text_description"
      readonly="readonly"></textarea></td>
    <td></td>
   </tr>
   <tr class="descr_detail">
 ...
 <div class="choice">
  <hr>
  <input id="btn_choose_attr_cancel" type="button" class="input_pad" value="Cancel"
   onclick="$('#dia_set_attr').dialog('close')" /> <input id="btn_choose_attr_ok" class="input_pad"
   type="button" value="OK" onclick="logic.choose_attribute()" />
 </div>
</div>

<div id="dia_set_lo" title="Add Learning Objects">
 <div id="dia_set_lo_content">
  Select a learning object<select id="sel_set_lo" class="select_basic"
   onchange="ui.display_description(this, 0)"></select>
  <p class="item_description"></p>
 </div>
 <hr>
 <div class="choice">
  <input id="btn_choose_lo_cancel" type="button" class="input_pad" value="Cancel"
   onclick="$('#dia_set_lo').dialog('close')" /> <input id="btn_choose_lo_ok" class="input_pad"
   type="button" value="OK" onclick="logic.set_lo()" />
 </div>
</div>

<div id="dia_set_dom" title="Open Domain">
 <div id="dia_set_dom_content">
  Select a domain<select id="sel_set_dom" class="select_basic"
   onchange="ui.display_description(this, 2)"></select>
  <p class="item_description"></p>
 </div>
 <div class="choice">
  <hr>
  <input id="btn_choose_dom_cancel" type="button" class="input_pad" value="Cancel"
   onclick="$('#dia_set_dom').dialog('close')" /> <input id="btn_choose_dom_ok" class="input_pad"
   class="input_pad" type="button" value="OK"
   onclick="logic.load(JSON.parse($('#sel_set_dom').get(0).options[$('#sel_set_dom').get(0).selectedIndex].value).id)" />
 </div>
</div>
<div id="dia_rem_obj" title="Remove Object">
...
<div id="dia_rem_attr" title="Remove Attribute">
...
<div id="dia_create_obj" title="Create New Object">
 ...
 <div class="choice">
  <hr>
  <input id="btn_create_obj_cancel" type="button" class="input_pad" value="Cancel"
   onclick="ui.set_item(state.obj_index,0)" /> <input id="btn_create_obj_ok" class="input_pad"
...
<div id="dia_create_attr" title="Create New Attribute">
 ...
 <div class="choice">
  <hr>
  <input id="btn_create_attr_cancel" type="button" class="input_pad" value="Cancel"
   onclick="ui.set_item(state.attr_index,1)" /> <input id="btn_create_attr_ok" class="input_pad"
   type="button" value="OK"
...
<div id="dia_create_domain" title="Create New Domain">
 ...
 <div class="choice">
  <hr>
  <input id="btn_create_domain_cancel" type="button" class="input_pad" value="Cancel"
   onclick="$('#dia_create_domain').dialog('close')" /> <input id="btn_create_domain_ok"
   type="button" class="input_pad" value="OK"
...
<div id="dia_create_lo" title="Create New Learning Object">
 ...
 <div class="choice">
  <hr>
  <input id="btn_create_lo_cancel" type="button" class="input_pad" value="Cancel"
   onclick="$('#dia_create_lo').dialog('close')" /> <input id="btn_create_lo_ok" type="button"
   class="input_pad" value="OK"
 ...
 <table>
  <tr>
   <td><span style="position: absolute; text-align: left; left: 0; top: 0; padding: 3px"> <input
     type="checkbox" id="cb_latticeview" style="width: 20px" onclick="lattice.switch_view()" />Show
     full lattice
   </span></td>
   <td>
