...
$german = array (
    ...
    'wespot_fca:cancel' => "Abbrechen",
    'wespot_fca:save' => "Speichern",
    'wespot_fca:ok' => "OK",
    'wespot_fca:move_left' => "Nach Links",
    'wespot_fca:move_right' => "Nach Rechts",
    'wespot_fca:move_up' => "Nach Oben",
    'wespot_fca:move_down' => "Nach Unten",
    
    'wespot_fca:intent' => "Attributlabel",
    'wespot_fca:intent_ibl' => "Fähigkeiten",
    'wespot_fca:extent' => "Objektlabel",
    'wespot_fca:extent_ibl' => "Aktivitäten",

    'wespot_fca:attr' => "Merkmal",
    'wespot_fca:attrs' => "Merkmale",
    'wespot_fca:attrs_ibl' => "Fähigkeiten",
    'wespot_fca:attr:add' => "Merkmal Hinzufügen",
    'wespot_fca:attr:set' => "Merkmal Setzen",
    'wespot_fca:attr:rem' => "Merkmal Entfernen",
    'wespot_fca:attr:rem_sure' => "Sind Sie sicher, dass Sie folgendes Merkmal entfernen möchten:",
    ...
    'wespot_fca:objs_ibl' => "Aktivitäten",
    'wespot_fca:obj:add' => "Gegenstand Hinzufügen",
    'wespot_fca:obj:set' => "Gegenstand Setzen",
    'wespot_fca:obj:rem' => "Gegenstand Entfernen",
    'wespot_fca:obj:rem_sure' => "Sind Sie sicher, dass Sie folgenden Gegenstand entfernen möchten:",
