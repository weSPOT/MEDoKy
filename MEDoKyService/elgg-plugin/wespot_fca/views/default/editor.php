...
//logic.init("<?php echo $basedir; ?>","http://berndpruenster.org/webapps/MEDoKyService/rest/FCATool/", <?php echo json_encode($files_json); ?>);
logic.init("<?php echo $basedir; ?>","http://css-kti.tugraz.at/MEDoKyService/rest/FCATool/", <?php echo json_encode($files_json); ?>);
});
</script>
<table id="toolbar">
  <tr>
...
<div id="main_table">
  <table id="input">
    ...
    <tr>
      ...
      <td class="td_attr td_attr_0"><input type="image" src="<?php echo $basedir; ?>img/left.svg" id="btn_move_left_0"
        width="16px" height="40px" alt="&lt;" title="<?php echo elgg_echo('wespot_fca:move_left'); ?>"
        class="input btn_move_left" onclick="ui.move_left(0)" /><input type="image"
        src="<?php echo $basedir; ?>img/right.svg" id="btn_move_right_0" width="16px" height="40px" alt="&gt;"
        title="<?php echo elgg_echo('wespot_fca:move_right'); ?>" class="input btn_move_right"
        onclick="ui.move_right(0)" /><input type="button" id="attr_0" class="input btn_attr col"
        value="<?php echo elgg_echo('wespot_fca:attr:dummy'); ?> 1" onclick="ui.set_item(0,entity_types.attribute)" /></td>
      <td class="td_attr td_attr_1"><input type="image" src="<?php echo $basedir; ?>img/left.svg" id="btn_move_left_1"
        width="16px" height="40px" alt="&lt;" title="<?php echo elgg_echo('wespot_fca:move_left'); ?>"
        class="input btn_move_left" onclick="ui.move_left(1)" /><input type="image"
        src="<?php echo $basedir; ?>img/right.svg" id="btn_move_right_1" width="16px" height="40px" alt="&gt;"
        title="<?php echo elgg_echo('wespot_fca:move_right'); ?>" class="input btn_move_right"
        onclick="ui.move_right(1)" /><input type="button" id="attr_1" class="input  btn_attr col"
        value="<?php echo elgg_echo('wespot_fca:attr:dummy'); ?> 2" onclick="ui.set_item(1,entity_types.attribute)" /></td>
      <td class="td_attr td_attr_2"><input type="image" src="<?php echo $basedir; ?>img/left.svg" id="btn_move_left_2"
        width="16px" height="40px" alt="&lt;" title="<?php echo elgg_echo('wespot_fca:move_left'); ?>"
        class="input btn_move_left" onclick="ui.move_left(2)" /><input type="image"
        src="<?php echo $basedir; ?>img/right.svg" id="btn_move_right_2" width="16px" height="40px" alt="&gt;"
        title="<?php echo elgg_echo('wespot_fca:move_right'); ?>" class="input btn_move_right"
        onclick="ui.move_right(2)" /><input type="button" id="attr_2" class="input  btn_attr col"
        value="<?php echo elgg_echo('wespot_fca:attr:dummy'); ?> 3" onclick="ui.set_item(2,entity_types.attribute)" /></td>
      <td class="td_attr td_attr_3"><input type="image" src="<?php echo $basedir; ?>img/left.svg" id="btn_move_left_3"
        width="16px" height="40px" alt="&lt;" title="<?php echo elgg_echo('wespot_fca:move_left'); ?>"
        class="input btn_move_left" onclick="ui.move_left(3)" /><input type="image"
        src="<?php echo $basedir; ?>img/right.svg" id="btn_move_right_3" width="16px" height="40px" alt="&gt;"
        title="<?php echo elgg_echo('wespot_fca:move_right'); ?>" class="input btn_move_right"
        onclick="ui.move_right(3)" /><input type="button" id="attr_3" class="input  btn_attr col"
        value="<?php echo elgg_echo('wespot_fca:attr:dummy'); ?> 4" onclick="ui.set_item(3,entity_types.attribute)" /></td>
      <td class="tail" style="background-color: #fff; vertical-alignment: middle"><input type="image" class="input"
        style="border: none; padding-left: 10px;" src="<?php echo $basedir; ?>img/plus.svg" width="16px" height="16px"
        alt="+" title="<?php echo elgg_echo('wespot_fca:attr:add'); ?>" onclick="ui.append_attribute()" /><?php echo elgg_echo('wespot_fca:attr:add'); ?></td>
    </tr>
    <tr id="tr_obj_0" class="tr_obj">
      <td class="left"><input type="image" src="<?php echo $basedir; ?>img/up.svg" width="40px" height="16px" alt="^"
        title="<?php echo elgg_echo('wespot_fca:move_up'); ?>" id="btn_move_up_0" class="input btn_move_up"
        onclick="ui.move_up(0)" /> <input type="image" src="<?php echo $basedir; ?>img/down.svg" width="40px"
        height="16px" alt="v" title="<?php echo elgg_echo('wespot_fca:move_down'); ?>" id="btn_move_down_0"
    ...
    <tr id="tr_obj_1" class="tr_obj">
      <td class="left"><input type="image" src="<?php echo $basedir; ?>img/up.svg" width="40px" height="16px" alt="^"
        title="<?php echo elgg_echo('wespot_fca:move_up'); ?>" id="btn_move_up_1" class="input btn_move_up"
        onclick="ui.move_up(1)" /> <input type="image" src="<?php echo $basedir; ?>img/down.svg" width="40px"
        height="16px" alt="v" title="<?php echo elgg_echo('wespot_fca:move_down'); ?>" id="btn_move_down_1"
    ...
    <tr id="tr_obj_2" class="tr_obj">
      <td class="left"><input type="image" src="<?php echo $basedir; ?>img/up.svg" width="40px" height="16px" alt="^"
        title="<?php echo elgg_echo('wespot_fca:move_up'); ?>" id="btn_move_up_2" class="input btn_move_up"
        onclick="ui.move_up(2)" /> <input type="image" src="<?php echo $basedir; ?>img/down.svg" width="40px"
        height="16px" alt="v" title="<?php echo elgg_echo('wespot_fca:move_down'); ?>" id="btn_move_down_2"
    ...
    <tr id="tr_obj_3" class="tr_obj">
      <td class="left"><input type="image" src="<?php echo $basedir; ?>img/up.svg" width="40px" height="16px" alt="^"
        title="<?php echo elgg_echo('wespot_fca:move_up'); ?>" id="btn_move_up_3" class="input btn_move_up"
        onclick="ui.move_up(3)" /> <input type="image" src="<?php echo $basedir; ?>img/down.svg" width="40px"
        height="16px" alt="v" title="<?php echo elgg_echo('wespot_fca:move_down'); ?>" id="btn_move_down_3"
    ...
    <tr id="tr_obj_4" class="tr_obj">
      <td class="left"><input type="image" src="<?php echo $basedir; ?>img/up.svg" width="40px" height="16px" alt="^"
        title="<?php echo elgg_echo('wespot_fca:move_up'); ?>" id="btn_move_up_4" class="input btn_move_up"
        onclick="ui.move_up(4)" /> <input type="image" src="<?php echo $basedir; ?>img/down.svg" width="40px"
        height="16px" alt="v" title="<?php echo elgg_echo('wespot_fca:move_down'); ?>" id="btn_move_down_4"
...
<div id="dia_set_attr" title="<?php echo elgg_echo('wespot_fca:attr:set'); ?>">
  ...
  <div class="choice">
    ...
    <input id="btn_choose_attr_cancel" type="button" class="input_pad"
      value="<?php echo elgg_echo('wespot_fca:cancel'); ?>" onclick="$('#dia_set_attr').dialog('close')" /> <input
      id="btn_choose_attr_ok" class="input_pad" type="button" value="<?php echo elgg_echo('wespot_fca:ok'); ?>"
      onclick="logic.choose_item(entity_types.attribute)" />
  </div>
</div>
...
<div id="dia_create_lo" title="Create New Learning Object">
  ...
  <div class="choice">
    ...
    <input id="btn_create_lo_cancel" type="button" class="input_pad"
      ...
      id="btn_create_lo_ok" type="button" class="input_pad" value="<?php echo elgg_echo('wespot_fca:ok'); ?>"
