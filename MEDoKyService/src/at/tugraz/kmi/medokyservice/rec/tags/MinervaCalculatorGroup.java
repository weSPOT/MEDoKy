...
public class MinervaCalculatorGroup extends MinervaCalculator implements TagRecommender{
	...
	public List<String> getRankedTagList(String inquiryId, String userId,
		...
		List<ContentTags> groupTags = dbClient.getContentFeatureTagsByGroup(inquiryId);
		return this.calculateRankedTagList(semanticFeatures, groupTags, number);
	}
}
